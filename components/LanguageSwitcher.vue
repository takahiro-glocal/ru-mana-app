<template>
  <div class="tw-relative">
    <button
      ...
      :class="[
        'tw-flex tw-items-center tw-gap-1.5 tw-rounded-full tw-px-3 tw-py-1.5 tw-text-sm tw-font-bold tw-transition-colors tw-border-0 tw-cursor-pointer',
        variant === 'light'
          ? 'tw-bg-white/20 tw-backdrop-blur-sm tw-text-white hover:tw-bg-white/30'
          : 'tw-bg-[#4B3E8E]/10 tw-text-[#4B3E8E] hover:tw-bg-[#4B3E8E]/20'
      ]"
    >
